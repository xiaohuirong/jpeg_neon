...
void dct_block(int gap, int in[], double out[])
{
  ...
  for(i=0;i<8;i++){
    float32x4_t X1 = (float32x4_t){in[i*gap+0] - 128 , in[i*gap+1] - 128, in[i*gap+2] - 128, in[i*gap + 3] - 128};
    float32x4_t X2 = (float32x4_t){in[i*gap+4] - 128 , in[i*gap+5] - 128, in[i*gap+6] - 128, in[i*gap + 7] - 128};
